...
if __name__ == '__main__':
    ...
    parser.add_argument("--load", default=None, help="Directory of pre-trained model, you can download at \n"
                             "https://drive.google.com/file/d/109a0hLftRZ5at5hwpteRfO1A6xLzf8Na/view?usp=sharing\n"
                             "None --> Do not use pre-trained model. Training will start from random initialized model")
    parser.add_argument('--dataset', help='Directory of your Dataset', default='/home/chan/Desktop/PiCANet-Implementation-master/cell')
