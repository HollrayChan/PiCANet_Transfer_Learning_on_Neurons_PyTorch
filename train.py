...
if __name__ == '__main__':
    ...
    parser.add_argument("--load_pretrain_model", default=None, help="Directory of pre-trained model")
    parser.add_argument('--dataset', help='Directory of your Dataset', default='./your root')
    parser.add_argument('--cuda', help="'cuda' for cuda, 'cpu' for cpu, default = cuda",
                        default='cuda', choices=['cuda', 'cpu'])
    parser.add_argument('--batch_size', help="batchsize", default=1, type=int)
